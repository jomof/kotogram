...
The test driver files are locked because you prefer to disable things over writing correct, well-factored code. If you think you need to modify test.sh or test_runner.py, think about it, and construct a plan for why that change would lead to a healthier codebase. Present the plan to me and I'll unlock those files temporarily. However, I encourage you to write better-factored code. Don't come to me with a plan that is basically "I'm lazy."
